...
where inst.ProductName0 like 'Microsoft Visual C++ 2015-2022 Redistributable (x64)%' and col.CollectionID = 'CollectionID'
...
case
    when  inst.Version0 >= '2.0.9254.0' then 'Compliant'
	when  inst.Version0 >= '2.%' and inst.Version0 < '2.0.9254.0' then 'Outdated'
    else 'Non-Compliant'
end status,
...
where inst.DisplayName0 like 'Microsoft Visual C++ 2015-2022 Redistributable (x64)%' and col.CollectionID = 'CollectionID'
