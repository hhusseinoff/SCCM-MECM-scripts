...
where inst.ProductName0 like '%OneDrive%' and col.CollectionID = 'CollectionID'
...
case
    when  inst.ProductVersion0 >= '117.0.2045.47' then 'Compliant'
	when  inst.ProductVersion0 != '117.0.2045.47' and inst.ProductVersion0 like '11%' and inst.ProductVersion0 not like '109.%' then 'Non-Compliant'
