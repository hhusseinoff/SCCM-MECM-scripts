...
FCM.CollectionID ='ZON0010F' and FCM.ResourceID not in 
(
...
where inst.ProductName0 like 'VMWare Tools' and col.CollectionID = 'ZON0010F'
...
case
    when  inst.Version0 >= '12.3.0.22234872' then 'Compliant'
	when  inst.Version0 >= '12.%' and inst.Version0 < '12.3.0.22234872' then 'Outdated'
    else 'Non-Compliant'
end status,
...
where inst.DisplayName0 like 'VMWare Tools' and col.CollectionID = 'ZON0010F'
