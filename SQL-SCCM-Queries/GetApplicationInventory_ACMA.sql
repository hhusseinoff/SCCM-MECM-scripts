...
where inst.ProductName0 like 'Azure Connected%' and col.CollectionID = 'CollectionID'
...
case
    when  inst.ProductVersion0 >= '1.36.02501.1366' then 'Compliant'
	when  inst.ProductVersion0 >= '1.30.%' and inst.ProductVersion0 < '1.36.02501.1366' then 'Outdated'
    else 'Non-Compliant'
end status,
