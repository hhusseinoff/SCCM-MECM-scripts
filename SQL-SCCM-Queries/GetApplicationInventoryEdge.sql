...
where inst.ProductName0 like 'Microsoft Edge' and col.CollectionID = 'CollectionID'
...
case
    when  inst.ProductVersion0 >= '119.0.2151.72' then 'Compliant'
	when  inst.ProductVersion0 != '119.0.2151.72' and inst.ProductVersion0 like '11%' and inst.ProductVersion0 not like '109.%' then 'Non-Compliant'
